...
public class GoogleAspectRatioFrameLayout extends FrameLayout {
    ...
    /**
     * Resize modes for {@link GoogleAspectRatioFrameLayout}. One of {@link #RESIZE_MODE_FIT}, {@link
    ...
    public GoogleAspectRatioFrameLayout(Context context) {
        this(context, /* attrs= */ null);
    }

    public GoogleAspectRatioFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GoogleAspectRatioFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setAspectRatio(float widthHeightRatio) {
        if (Float.compare(widthHeightRatio, videoAspectRatio) != 0) {
    ...
    protected void setResizeModeInner(@ResizeMode int resizeMode) {
        this.resizeMode = resizeMode;
    }
